  ...
  return (
    <Section id="how-to-use">
     <div className="container">
        <Heading title="Generative AI made for cteators." 
        text="Brainwave unlocks the potential of AI-powered applications" />

      <div className="relative">
        <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem] ">
         <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
          <img className="w-full h-full object-cover md:object-right" src={service1} width={800} alt="Smartest AI" height={730} />
         </div>
        ...
        <div className="relative z-1 grid gap-5 lg:grid-cols-2">
          ...
          <p className="body-2 mb-[3rem] text-n-3">Automatically echance your photos using oru AI app&apos;sphoto editing feature. Try it now!</p>
          </div>
          ...
          <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:main-h-[46rem]">
            <div className="py-12 px-4 xl:px-8">
                <h4 className="h4 mb-4">Video generetion</h4>
